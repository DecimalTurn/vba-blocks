...
Public Function Validate() As String
    ...
    If ThisWorkbook.VBProject.VBComponents.Count <> 6 Then
        Errors.Add "Found " & ThisWorkbook.VBProject.VBComponents.Count & " components (expected 6)"
    End If
    ...
    ComponentNames = Array("Class1")
    Components = Array(New Class1)
